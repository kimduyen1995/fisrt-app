...
MIDDLEWARE = [
    ...
    # 'my_app.my_http.middlewares.authen_user_middleware.AuthenUserMiddleware',
    # # 'my_app.my_http.middlewares.user_permission_middleware.UserPermissionMiddleware'
    # 'my_app.my_http.middlewares.new_user_permission_middleware.NewUserPermissionMiddleware',
]
